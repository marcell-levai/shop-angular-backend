...
import { badRequestResponse, errorResponse, okResponse } from '@libs/response-factory';

const importProductsFile = (s3Client: AWS.S3): ValidatedEventAPIGatewayProxyEvent<typeof schema> => async (event) => {
  try {
